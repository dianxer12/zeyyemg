create or replace view jzs.egret_v_jz_lqbrxx as
...
grant select on jzs.egret_v_jz_lqbrxx to egret;

create or replace view egret.jz_lqbrxx as
Select * From jzs.egret_v_jz_lqbrxx;