--急诊预检病人登记表
DROP TABLE JZ_JZYJBRDJB;
CREATE TABLE JZ_JZYJBRDJB
(
  ...
  GHJLXH NUMBER(10)    NULL,        --挂号记录序号
  CONSTRAINT PK_JZ_JZYJBRDJB PRIMARY KEY(JLXH)
)tablespace JZGLXT;
CREATE INDEX IDX_JZ_JZYJBRDJB_DJRQ ON JZ_JZYJBRDJB(DJRQ);
CREATE INDEX IDX_JZ_JZYJBRDJB_RYSJ ON JZ_JZYJBRDJB(RYSJ);
CREATE INDEX IDX_JZ_JZYJBRDJB_JZKH ON JZ_JZYJBRDJB(JZKH);
CREATE INDEX IDX_JZ_JZYJBRDJB_BRXM ON JZ_JZYJBRDJB(BRXM);